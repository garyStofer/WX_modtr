...
function iocfg(ta,tb,tc,tf,tg,pa,pb,pc,pf,pg,xdb)
{
	...
	<table class=bBox cellpadding=3 cellspacing=1> \
		...
		When checked, the port is configured as an output pin. When not checked, it is configured as an input pin. \
		Unavailabe ports are hidden when expansion modules are using them.\
		</td></tr> \
		...
		drawCheckboxesRow("Port G:","trisg",(xdb==2||xdb==3)?0x0e:0x0f,~tg); /* for IOr5e/WX hide the button  for RTC enable/disable*/
	...
	document.write(" \
		...
		When checked, the port is set (5V). When not checked, the port is clear (0V).\
		Unavailabe ports are hidden when expansion modules are using them.\
		</td></tr> \
		<tr><td class=bLbl><b>Port Pin</b></td> \
			<td class=bCel align=center><b>7</b></td> \
		...
		drawCheckboxesRow("Port G:","portg",(xdb==2||xdb==3)?0x0e:0x0f,pg);		/* For IOr5e hide the button for RTC enable/disable line G0*/
