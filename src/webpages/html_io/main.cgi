...
function execCmd(name, value) {
	var x = document.getElementById("formCfgPin").action	+ "?" + name + "=" + value;
	alert(x);
	window.location = document.getElementById("formCfgPin").action	+ "?" + name + "=" + value;
...
<body marginwidth="0" marginheight="0" topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0">
 ...
 <script type="text/javascript">  document.write( window.location.protocol);  </script>
 <br>
 <script type="text/javascript">  document.write( window.location.href);  </script>
 <br>
 <script type="text/javascript">  document.write( window.location.search);  </script>
...
<form method="GET" action="main.cgi">
	<b>B0: &nbsp; </b>
	<input %b48 type=radio value="1" name="bc0r">Input &nbsp; <input %b40 type=radio value="0" name="bc0r">Output
	<br><b>B1: &nbsp; </b>
	<input %b49 type=radio value="1" name="bc1r">Input &nbsp; <input %b41 type=radio value="0" name="bc1r">Output
	<br> &nbsp; 
...
<form method="get" action="main.cgi">
  ...
  <br>
  B1: <script type="text/javascript">ln(%b51,%b01,"bx1");</script>
</form>
<form  id= "frmrtc" method ="get" action = "main.cgi">
	Year <input type=text size=10 maxlength=5 value=%x40 name="xtY" > <br>
	Month <input type=text size=10 maxlength=5 value=%x41 name="xtM" > <br>
