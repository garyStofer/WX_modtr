...
function doSubmit() {
	for (i=1;i<5;i++) {
		...
		{
var x = document.getElementsByName("w"+i)[0].name;
			document.getElementsByName("w"+i)[0].name = "w"+i+"r";
	x = document.getElementsByName("w"+i)[0].name;		
		}
	}
}
...
<tr
><td class=bBot colspan=2><input type=submit value="Update">&nbsp;  &nbsp;
 Remember Settings After Power Up <input type=checkbox id=rem></td>
 </tr>
</table>
