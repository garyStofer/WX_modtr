...
<!--Dewpoint = %l55 degreees F<br> -->

<form  id= "frmWXConf" method ="get" action = "wx.cgi">
<p> 
Temp Cal:<input type="text" size="3"  maxlength="3" value="%kB7" name="kB7"/> <br/>
Baro Cal:<input type="text" size="3"  maxlength="3" value="%kB8" name="kB8"/>&nbsp;&nbsp;
Baro Cal_offset:<input type="text" size="3"  maxlength="3" value="%kBB" name="kBB"/> <br/>
Hyg  Cal:<input type="text" size="3"  maxlength="3" value="%kB9" name="kB9"/>&nbsp;&nbsp;&nbsp; 
Hyg  Cal_offset:<input type="text" size="3"  maxlength="3" value="%kBC" name="kBC"/> <br/>
Sol  Cal:<input type="text" size="3"  maxlength="3" value="%kBA" name="kBA"/> <br/>
<input type="hidden" name="m" value="r"/> 
<input type="submit" value="Set Calibration Params & Reset "/>
</p>
</form>
...
<input type=text size=3  maxlength=3 value="%k94" name="k94"/>&nbsp;&nbsp;  <em>Default for 
&quot;weatherstation.wunderground.com&quot; is 38.102.136.125 </em><br/><br/>

<input type="submit"  value="Set Station Params & Reset "/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</form>
