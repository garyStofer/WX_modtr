...
<h4>Real time clock on IOr5e board</h4>
<pre>
Year = %%x40 Month = %%x41 Day = %%x42 Hour = %%x43 Minute=%%x44  </pre>
This code above is displayed as:<br>

Year = %x40 Month = %x41 Day = %x42 Hour = %x43 Minute=%x44  Seconds=%x45<br>
<br>
To set the RTC use http get commands:<br>
xtY=nnnn for year, xtM=nn for Month, xtD= nn for Day, xtH=nn for Hour and xtm=nn for minutes and xts for seconds
<br>
</body>
</html>
