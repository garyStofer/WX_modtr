...
// WARNING !! Make sure that UART1 is configured "Enabled" and with the correct Baud Rate of 57600 
// via the webinterface, first, before you build and flash a version with DEBUG_OFF commented out !!
// Failure to do so will hang the board
...
#define MY_DEFAULT_MASK_BYTE2           (0xfful)
#define MY_DEFAULT_MASK_BYTE3           (0xfful)
