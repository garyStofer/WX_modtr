...
NEAR_TICK unsigned char  tick1sCount;
//NEAR_TICK unsigned short timer3Count;
...
void TickInit(void)
{
    ...
    // setup T3 as async counter using pin RC0-T1OSO pin
    // count is captured in the T1 ISR every 10 seconds   
    T3CON = 0b10000011; 	// 16Bit R/W, T1-clcok, run 
    TMR3H = 0;
    TMR3L = 0;
}
