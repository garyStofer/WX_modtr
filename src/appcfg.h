...
#define XBRD_TYPE_WX 	3   //Weathersation interface 
#define XBRD_TYPE_MAX   3   //Highest value used
...
enum APP_CONFIG_ENUM {
    ...
    APPCFG_WX_IP_ADDR0,			// Offset 145, Wunderground IP address byte 0
    ...
    APPCFG_WX_SATIONID,			// Offset 149, Wunderground station ID, max 16bytes
    APPCFG_WX_PASSWD = 165 ,	// offset 165, Wunderfround password String, max 16bytes
    APPCFG_WX_STATION_ELEVL=181, // Offset 181, Station altitude in feet, 2 bytes
  	APPCFG_WX_STATION_ELEVH
